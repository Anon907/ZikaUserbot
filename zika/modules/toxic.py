...
from zika.utils import extract_user, extract_user_and_reason
...
async def ngejamet(client: Client, message: Message):
    ...
    await asyncio.sleep(1.5)
    await zika.edit("**GUA CUMA MAU BILANG**")
    await asyncio.sleep(1.5)
    await zika.edit("**GAUSAH SO ASIK**")
    await asyncio.sleep(1.5)
    await zika.edit("**LO ITU JELEK HINA**")
    await asyncio.sleep(1.5)
    await zika.edit("**GAUSAH REPLY**")
    await asyncio.sleep(1.5)
    await zika.edit("**CUIH NAJIS BANGET DI REPLAY ORG HINA**")
    await asyncio.sleep(1.5)
    await zika.edit("**NAPA GA SENENG? YA PC LAH KONTOL**")
    await asyncio.sleep(1.5)
    await zika.edit("**BOCAH TOLOL**")
    await asyncio.sleep(1.5)
    await zika.edit("**MENTAL KALENG KERUPUK**")
    await asyncio.sleep(1.5)
    await zika.edit("**LEMBEK NGENTOT🥵**")
...
async def globalfake(client: Client, message: Message):
    ...
    await zika.edit(f"**Berhasil Gbanning🌐** \nFirst Name : [{user.first_name}](tg://user?id={user.id})\nReason : {reason}")
...
async def fakegmute(client: Client, message: Message):
    ...
    zika = await edit_or_reply(message, f"Memulai Proses Global mute [{user.first_name}](tg://user?id={user.id})")
    await asyncio.sleep(3)
    await zika.edit("`Memulai Proses Global mute🔄`")
    await asyncio.sleep(5)
    await zika.edit(f"**Berhasil Gmute🔇** \nFirst Name : [{user.first_name}](tg://user?id={user.id})\nReason : {reason}")
...
async def owner(client: Client, message: Message):
    ...
    await asyncio.sleep(1.5)
    await zika.edit("**MINGGIR LO!!**")
    await asyncio.sleep(1.5)
    await zika.edit("**IYA LO!!**")
    await asyncio.sleep(1.5)
    await zika.edit("**MINGGIR!!**")
    await asyncio.sleep(1.5)
    await zika.edit("**TU ADA OWNER GUA!!**")
    await asyncio.sleep(1.5)
    await zika.edit("**JANGAN BERISIK LU EGO!!**")
    await asyncio.sleep(1.5)
    await zika.edit("**SUNGKEM KEPADA LING**")
    await asyncio.sleep(1.5)
    await zika.edit("**🙇🙇🙇**")
...
async def toxicvirtual(client: Client, message: Message):
    ...
    zika = await edit_or_reply(message, "**OOOO**")
    await asyncio.sleep(1.5)
    await zika.edit("**INI YANG VIRTUAL**")
    await asyncio.sleep(1.5)
    await zika.edit("**YANG KATANYA SAYANG BANGET**")
    await asyncio.sleep(1.5)
    await zika.edit("**TAPI TETEP AJA DI TINGGAL**")
    await asyncio.sleep(1.5)
    await zika.edit("**NI INGET**")
    await asyncio.sleep(1.5)
    await zika.edit("**TANGANNYA AJA GA BISA DI PEGANG**")
    await asyncio.sleep(1.5)
    await zika.edit("**APALAGI OMONGANNYA**")
    await asyncio.sleep(1.5)
    await zika.edit("**BHAHAHAHA**")
    await asyncio.sleep(1.5)
    await zika.edit("**KASIAN MANA MASIH MUDA**")
