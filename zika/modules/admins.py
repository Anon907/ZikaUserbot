...
from zika.utils.misc import extract_user, extract_user_and_reason, list_admins
...
async def set_chat_photo(client: Client, message: Message):
    zika = (await client.get_chat_member(message.chat.id, client.me.id)).privileges
    can_change_admin = zika.can_change_info
