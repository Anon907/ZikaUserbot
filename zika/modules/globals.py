...
from zika.helpers.adminHelpers import DEVS, WHITELIST
from zika.helpers.basic import edit_or_reply
from zika.helpers.PyroHelpers import get_ub_chats
...
def globals_init():
    try:
        ...
        sql = import_module("zika.helpers.SQL.gban_sql")
        sql2 = import_module("zika.helpers.SQL.gmute_sql")
