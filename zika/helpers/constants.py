...
class First:
    ...
    REPO = """
**Hey**, __I am Robot__ ≥ **ZikaRobot** ≤

⭐ **Userbot Version :** `{}`
⭐ **Group Support :** [Zika Support Group](t.me/ZikaSupportGroup)
⭐ **Channel Ling :** [Not Perfect](t.me/heinoob)
⭐ **Owner Repo :** [Zika](t.me/Anon907)
⭐ **Repo :** [ZikaRobot](https://github.com/Anon907/ZikaUserbot)
...
DEPLOY [VIA HEROKU](https://telegram.dog/XTZ_HerokuBot?start=cmFtYWRoYW5pODkyL1JhbVB5cm8tQm90IGRyYWdvbnM)"""
    CREATOR = 'I was created by my master <a href="https://t.me/Anon907">Zika</a> on a rainy day.'
    MSG_ON = """
⭐ **ZikaRobot Menyala** ⭐
━━
➠ **Userbot Version -** `{}`
➠ **Ketik** `{}zika` **untuk Mengecheck Bot**
━━
"""
